...
//este iterador recorre la lista en un orden descendente determinado segun el tipo que se le pase
public class IteradorPersonajesConcreto4 implements IteratorPersonajes{
    private ArrayList<Personaje> personajesOrdenados;
    private int posicion;

    public IteradorPersonajesConcreto4(ArrayList<Personaje> personajes, int tipoOrden) {
